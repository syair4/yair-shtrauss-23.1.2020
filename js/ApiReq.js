  ...
  function currentConditionsReq (respFunc,city) {
    var url = "https://dataservice.accuweather.com/currentconditions/v1/locationKey?apikey="
    +apiKey+"&locationKey="+city.id;
  getReq(url,respFunc,city);
  }

  function fiveDayReq (respFunc,city) {
    var url = "https://dataservice.accuweather.com/forecasts/v1/daily/5day/locationKey?apikey="
    +apiKey+"&locationKey="+city.id+"&metric=true&details=true";
   getReq(url,respFunc,city);
  }

  function autocompleteReq (str,respondFunc) {
    var url = "https://dataservice.accuweather.com/locations/v1/cities/autocomplete?apikey="
